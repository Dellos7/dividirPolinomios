...
public class BaseGrebner {
	...
	public void BaseGrebner1() {
		...
		//Resultado
		Termino f11 = new Termino( numVariables, 1, new int[]{ 3, 0 } );
		Termino f12 = new Termino( numVariables, -2, new int[]{ 1, 1 } );
		Polinomio pol1 = new Polinomio();
		pol1.addTermino( f11 );
		pol1.addTermino( f12 );
		
		Termino f21 = new Termino( numVariables, 1, new int[]{ 2, 1 } );
		Termino f22 = new Termino( numVariables, -2, new int[]{ 0, 2 } );
		Termino f23 = new Termino( numVariables, 1, new int[]{ 1, 0 } );
		Polinomio pol2 = new Polinomio();
		pol2.addTermino( f21 );
		pol2.addTermino( f22 );
		pol2.addTermino( f23 );
		
		Termino f31 = new Termino( numVariables, -1, new int[]{ 2, 0 } );
		Polinomio pol3 = new Polinomio();
		pol3.addTermino( f31 );
		
		Termino f41 = new Termino( numVariables, -2, new int[]{ 1, 1 } );
		Polinomio pol4 = new Polinomio();
		pol4.addTermino( f41 );
		
		Termino f51 = new Termino( numVariables, -2, new int[]{ 0, 2 } );
		Termino f52 = new Termino( numVariables, 1, new int[]{ 1, 0 } );
	...
	public void BaseMinimal1() {
		...
		//Esperado
		Termino g11 = new Termino( numVariables, 1, new int[]{ 2, 0 } );
		Polinomio p3 = new Polinomio();
		p3.addTermino( g11 );
		
		Termino g21 = new Termino( numVariables, 1, new int[]{ 1, 1 } );
		Polinomio p4 = new Polinomio();
		p4.addTermino( g21 );
		
		Termino g31 = new Termino( numVariables, 1, new int[]{ 0, 2 } );
		Termino g32 = new Termino( numVariables, -1, 2, new int[]{ 1, 0 } );
	...
	public void BaseReducida1() {
		...
		//Esperado
		Termino h11 = new Termino( numVariables, 1, new int[]{ 2, 0 } );
		Polinomio h3 = new Polinomio();
		h3.addTermino( h11 );
		
		Termino h21 = new Termino( numVariables, 1, new int[]{ 1, 1 } );
		Polinomio h4 = new Polinomio();
		h4.addTermino( h21 );
		
		Termino h31 = new Termino( numVariables, 1, new int[]{ 0, 2 } );
		Termino h32 = new Termino( numVariables, -1, 2, new int[]{ 1, 0 } );

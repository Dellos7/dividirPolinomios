...
public class BaseGrebner2 {
	...
	public void baseGrebner2() {
		...
		//Resultado
		Termino f11 = new Termino( numVariables, 1, new int[]{ 1, 0, 0, 0 } );
		Termino f12 = new Termino( numVariables, -2, new int[]{ 0, 1, 0, 0 } );
		Termino f13 = new Termino( numVariables, -1, new int[]{ 0, 0, 1, 0 } );
		Termino f14 = new Termino( numVariables, -1, new int[]{ 0, 0, 0, 1 });
		...
		Termino f21 = new Termino( numVariables, 1, new int[]{ 0, 0, 1, 0 } );
		Termino f22 = new Termino( numVariables, 3, new int[]{ 0, 0, 0, 1 } );

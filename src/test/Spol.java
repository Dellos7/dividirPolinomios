...
public class Spol {
	...
	public void SpolTest2() {
		...
		Termino q1 = new Termino( numVariables, -1.0, new int[]{ 2, 0 } );
		Polinomio p2 = new Polinomio();
		p2.addTermino( q1 );
	...
	public void SpolTest3() {
		...
		Termino t1 = new Termino( numVariables, 1.0, new int[]{ 2, 1 } );
		Termino t2 = new Termino( numVariables, -2.0, new int[]{ 0, 2 } );
		Termino t3 = new Termino( numVariables, 1.0, new int[]{ 1, 0 } );
		Polinomio p1 = new Polinomio();
		p1.addTermino( t1 );
		p1.addTermino( t2 );
		p1.addTermino( t3 );
		...
		Termino q1 = new Termino( numVariables, -2.0, new int[]{ 1, 1 } );
		Polinomio p2 = new Polinomio();
		p2.addTermino( q1 );
